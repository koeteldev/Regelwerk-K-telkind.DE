# :server_icon: **__WILDLIFE-HIDEOUTSERVER-REGELWERK__** :server_icon: 

## **§1** **Geltungsbereich dieses Regelwerks**
          `●` Dieses Regelwerk ist gültig für den **Kötelkind.DE** Minecraft-Server und alle damit verbundenen Komponenten.
          `●` Mit dem Spielen auf **Kötelkind.DE** akzeptiert der Spieler diese Regeln und verpflichtet sich, diese zu befolgen. 
          `●` Beim Brechen dieser Regeln können vom **Kötelkind.DE** Serverteam Strafen in angemessener Stärke  ausgesprochen werden.
          `●` Wir behalten uns vor die Regeln jederzeit zu ändern. Ein regelmäßiger Blick in diesem Channel ist also kein Verlust. 
...
## **§3 Survival-Verhalten**
          `●` __Gib acht! Das Töten anderer Spieler ist erlaubt. Spawnfallen oder das Jagen von Spielern ist allerdings verboten.__
          ...
          `●` Gebäude, Schaltungen oder sonstige Anlagen, die dazu dienen, den Server zu schädigen sind verboten.
          `●` Das Nutzen von AFK-Maschinen ist untersagt. Spieler müssen aktiv spielen, um Fortschritte zu erzielen.

## §4 Wirtschaftssystem und Handel
          `●` Das absichtliche Manipulieren von Marktsystemen (z. B. durch Duplizierung oder Bugusing) ist strengstens untersagt.
